...
class GetNewFactHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        speak_output = "Can I ask questions?"
...
class ansintenthandler(AbstractRequestHandler):
    def can_handle(self, handler_input):
    # type: (HandlerInput) -> bool
    ...
    def handle(self, handler_input):
        ...
        speak_output = ask_utils.request_util.get_slot(handler_input, "answer").value
...
class CancelOrStopIntentHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        return handler_input.response_builder.ask(speak_output).response
...
sb.add_request_handler(ansintenthandler())
